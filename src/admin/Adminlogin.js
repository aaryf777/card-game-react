...
export default function Adminlogin() {
  ...
  return (
    submit ? <AdminotpVerify loginData={loginData}/>
    : <div className='w-full h-[80vh] flex flex-row justify-center items-center'>
      <div className='h-80 w-full bg-gray rounded-md m-3 md:w-1/3 lg:w-1/3 flex flex-col items-center gap-8'>
        <div className='text-base font-semibold text-white text-center my-3'>Admin Login Protal</div>
        ...
        <div className='flex flex-col gap-2 text-center'>
          ...
          <div className='flex text-gray-2 text-sm'>New User ? <Link to='/admin/signup' className='text-red font-semibold ml-2 cursor-pointer'> Signup</Link></div>
        </div>
